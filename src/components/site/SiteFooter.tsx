...
export default function SiteFooter() {
  return <footer className="site-footer dark-section">
    <div className="content-width footer-layout">
      ...
      <nav aria-label="Mais caminhos"><h2>Continue por aqui</h2><a href="/#declaracao-de-fe">Declaração de fé</a><a href="/#estudos-biblicos">Estudos bíblicos</a><a href="/blog">Blog da Reconciliação</a><a href="/#agenda">Agenda semanal</a></nav>
    ...
    <div className="content-width footer-bottom"><span>© {new Date().getFullYear()} Ministério Bíblico da Reconciliação</span><a href="/#conteudo">Voltar ao início ↑</a></div>
